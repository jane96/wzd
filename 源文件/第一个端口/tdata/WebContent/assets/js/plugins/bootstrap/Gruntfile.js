...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      test: {
        options: {
          jshintrc: 'assets/js/tests/unit/.jshintrc'
        },
        src: 'assets/js/tests/unit/*.js'
      },
      assets: {
        src: ['docs/assets/assets/js/src/*.js', 'docs/assets/assets/js/*.js', '!docs/assets/assets/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        dest: 'docs/assets/assets/js/customize.min.js'
      },
      docsJs: {
        src: configBridge.paths.docsJs,
        dest: 'docs/assets/assets/js/docs.min.js'
      }
    },
    ...
    'saucelabs-qunit': {
      all: {
        options: {
          ...
          maxRetries: 3,
          maxPollRetries: 4,
          urls: ['http://127.0.0.1:3000/assets/js/tests/index.html'],
  ...
  grunt.registerTask('commonjs', 'Generate CommonJS entrypoint module in dist dir.', function () {
    ...
    var destFilepath = 'dist/assets/js/npm.js';
